...
class TestProgramDataExtender(ModuleStoreTestCase):
    ...
    def test_can_enroll(self, can_enroll, mock_has_access):
        ...
        self._assert_supplemented(data, can_enroll=can_enroll)
...
class TestProgramMarketingDataExtender(ModuleStoreTestCase):
    ...
    def _create_course(self, course_price):
        ...
        course_run = CourseRunFactory(key=unicode(course.id), seats=[SeatFactory(price=course_price)])
    ...
    def test_course_pricing(self):
        ...
        program_full_price = self.course_price * self.number_of_course
        self.assertEqual(data['number_of_courses'], self.number_of_course)
        self.assertEqual(data['full_program_price'], program_full_price)
        self.assertEqual(data['avg_price_per_course'], program_full_price / self.number_of_course)
